...
while IFS= read -r path; do
  case "$path" in
    ./.gitignore|./README.md|./AGENTS.md|./SECURITY.md|./CONNECTOR_README.md|./STATUS.md|./ROADMAP.md|./maps|./maps/*|./registries|./registries/*|./policies|./policies/*|./audits|./audits/*|./scripts|./scripts/*|./notes|./notes/*|./.git|./.git/*)
      ;;
    *)
